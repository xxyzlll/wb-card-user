  ...
  <main class="container">
    <el-container>
      <el-header height="auto" class="fixed-header">
        ...
        <el-card class="stats-card">
          <div class="stats-info">
            <el-statistic title="总私信数" :value="historyList.length" />
            <el-statistic title="今日私信" :value="todayCount" />
            <el-statistic title="本周私信" :value="weekCount" />
          </div>
        </el-card>
      </el-header>
      ...
      <el-main class="scrollable-content">
            ...
            <div class="history-content">
              ...
              <div class="record-info">
                ...
                <div class="message-content">
                  <el-tag type="info" size="small">私信内容</el-tag>
                  <p>{{ record.content }}</p>
                </div>
              </div>
        ...
        <el-empty v-else description="暂无私信历史记录">
          <el-button type="primary" @click="goBack">去发送私信</el-button>
        </el-empty>
      </el-main>
...
function loadHistory(): void {
  historyList.value = LocalStorage.getMessageHistory();
}
...
function removeRecord(userId: string | number): void {
  ElMessageBox.confirm(
    ...
    LocalStorage.removeMessageRecord(userId);
    loadHistory();
...
function clearHistory(): void {
  ElMessageBox.confirm(
    ...
    LocalStorage.clearMessageHistory();
    loadHistory();
